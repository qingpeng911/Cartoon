<template>
	<div>
		...
		<div class="ranking mhDeail newList" v-show="!loading">
      <div class="main">
        <div class="bgDiv">
          <img src="http://img.boook.cc/cartoon/static/img/new_bg.png" class="bgImg">
        </div>
        <div class="time">
          亲 , 我们会实时推送新漫画哦!
        </div>
...
export default {
  ...
  methods: {
    next() {
      ...
      api.getRankNew({pageSize:10, page:this.page}).then(res => {
        this.loading = false;
